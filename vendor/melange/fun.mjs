...
var Finally_raised = /* @__PURE__ */ Caml_exceptions.create(
...
function protect($$finally, work) {
  ...
  try {
    ...
    Caml_external_polyfill.resolve("caml_restore_raw_backtrace")(
      work_exn,
      work_bt,
    );
    throw work_exn;
...
export { $$const, flip, negate, protect, Finally_raised };
/*  Not a pure module */
